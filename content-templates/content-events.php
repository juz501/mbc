            ...
            while ( have_rows( 'event_list') ) : 
              ...
              ?><div class="event"><?php
                ...
                if ( $has_second_time ) :
                  ...
                  ?> &amp; <?
                  ?><span class="hour"><?php echo date( 'g', $second_event_time ); ?></span><?php
                  ?><span class="time-divider">:</span><?php
                  ?><span class="minutes"><?php echo date( 'i', $second_event_time ); ?></span><?php
                  ?><span class="ampm"><?php echo date( 'a', $second_event_time ); ?></span><?php
                endif;
                ?><div class="date">
